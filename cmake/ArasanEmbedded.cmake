...
function(add_arasan_embedded_library target)
    ...
    string(JSON arasan_manifest_network_path GET "${arasan_upstream_json}" network sourcePath)
    get_filename_component(arasan_manifest_network "${arasan_manifest_network_path}" NAME)
